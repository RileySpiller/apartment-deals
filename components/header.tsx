        ...
        <div className="flex justify-between items-center py-4">
            ...
            <Link href="/" className="flex items-center">
              ...
              <div className="relative w-8 h-8 mx-1">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-3 h-3 bg-blue-500 rounded-full transform translate-x-0.5 translate-y-0.5"></div>
                </div>
              </div>
          ...
          <nav className="hidden md:flex items-center space-x-1">
            <div className="border border-gray-300 rounded-full py-1 px-4">
              <Link href="/get-listed" className="text-sm text-gray-700 hover:text-gray-900">
                Get Listed
              </Link>
              <span className="mx-3 text-gray-300">|</span>
              <Link href="/weekly-report" className="text-sm text-gray-700 hover:text-gray-900">
                Our Weekly Report
              </Link>
              <span className="mx-3 text-gray-300">|</span>
              ...
              <span className="mx-3 text-gray-300">|</span>
              <Link href="/advertise" className="text-sm text-gray-700 hover:text-gray-900">
                Advertise
              </Link>
            </div>
          </nav>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link
              href="/signup"
              className="hidden md:flex items-center bg-blue-500 text-white px-4 py-2 rounded-full text-sm font-medium hover:bg-blue-600"
            >
